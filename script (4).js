...
const WEEKS = [
  ...
  },
  {
    ...
    number:      6,
    emoji:       '👥',
    title:       'Influential figures (Group Sharing)',
    description: 'A time for group sharing and reflection on the influential figures in our lives — those who have shaped our faith, character, and journey.',
  },
  {
    id:          'week-7',
    type:        'week',
...
const ASSIGNMENTS = [
  ...
  },
  {
    ...
    number:      6,
    emoji:       '💡',
    title:       'Chasing the Light and Leave the Fantasy, come the Truth',
    description: 'Reflect on the pursuit of truth over illusion — what fantasies have you been chasing, and how does the light of Christ call you into His reality?',
  },
  {
    id:          'assignment-7',
    type:        'assignment',
